...
def calculate_psnr(original, encoded, resolution, frames, original_bitdepth=8, encoded_bitdepth=8):
    MAX_VALUE = 1020
...
#     original_video = "../dataset/foreman.yuv"
#     encoded_video = "../decoded/br7000/foreman.yuv"
#     resolution = (416, 240)
#     frames = 5
